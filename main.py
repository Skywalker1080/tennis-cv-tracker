...
def main():
    ...
    for ball_shot_ind in range(len(ball_shot_frames)-1):
        ...
        distance_covered_by_ball_meters = convert_pixels_to_meters(
            distance_covered_by_ball_pixels,
            constants.DOUBLE_LINE_WIDTH,
            mini_court.get_width_of_court()
        )
        ...
        distance_covered_by_opponent_meters = convert_pixels_to_meters(
    ...
    overlay_output = mini_court.draw_points_on_mini_court(overlay_output,player_mini_court_detections)
    overlay_output = mini_court.draw_points_on_mini_court(overlay_output,ball_mini_court_detections, color=(0,255,255))

    # Draw Player Stats
    overlay_output = draw_player_stats(overlay_output,player_stats_data_df)
